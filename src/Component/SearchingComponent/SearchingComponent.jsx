...
const SearchingComponent = () => {
    return (
        <div className='w-10/12 mx-auto '>
            <div className='flex md:space-x-4 space-x-6 justify-center bg-white md:w-1/4 w-full shadow-lg  p-4 text-center relative  md:-top-36 -top-20 rounded-t-2xl border-b-2 border-gray-400 z-40'>
            ...
            <div className='md:flex justify-between md:space-y-0 space-y-4 bg-white py-12 px-8 shadow-2xl md:-top-36 -top-20 relative  rounded-b-2xl md:rounded-r-2xl z-40'>
                <div>
